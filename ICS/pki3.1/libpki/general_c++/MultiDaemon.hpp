 ...
 *
 */
#ifndef ISSAC_MULTI_DAEMON_HPP_
#define ISSAC_MULTI_DAEMON_HPP_
...
class MultiDaemonError : public Exception
{
public:
  MultiDaemonError(const std::string &s = 
    "MultiDaemonError") : Exception(s) {}
};

class MultiDaemon;
typedef int (MultiDaemon::*MD_PROC)();

class MultiDaemon : public Daemon
{
protected:
  Socket _sockConn;
...
public:
  ...
  void registerProcess(int port, int (MultiDaemon::*proc)());
